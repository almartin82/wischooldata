...
#
# Data Sources:
# - WISEdash (2016+): https://dpi.wi.gov/wisedash/download-files
# - Published Excel files (1997-2015): https://dpi.wi.gov/cst/published-enrollment-data
#
# ==============================================================================
...
#' - **WISEdash** (2016-present): CSV files with detailed demographic breakdowns
...
#'   Set to FALSE to force re-download from DPI.
...
fetch_enr <- function(end_year, tidy = TRUE, use_cache = TRUE) {
  ...
  # Get raw data from Wisconsin DPI
