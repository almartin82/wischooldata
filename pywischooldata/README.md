...
Python wrapper for Wisconsin school enrollment data.

This is a thin rpy2 wrapper around the [wischooldata](https://github.com/almartin82/wischooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `wischooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/wischooldata")

# Then install the Python package
pip install pywischooldata
```
...
# Fetch one year
df = wi.fetch_enr(2025)

# Fetch multiple years
df_multi = wi.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
